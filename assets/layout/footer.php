      ...
      <div class="container">
         <div class="row">
            <div class="ban-form" data-form-type="signup_form">
               <form class="cmxform offr-frm has-validation-callback" method="POST" action="mail.php" novalidate>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <div class="fldset">
                           ...
                           <textarea name="msg" id="message" rows="7" placeholder="Talk About Your Project *" required></textarea>
                           <small class="error-message" style="color: red; display: none; position: relative; top: 5px;">This field is required.</small>
                        </div>
                     </div>
                     <div class="col-md-12">
