...
!(function (e, t) {
  ...
  "use strict";
  var t,
      r = (e = e && "default" in e ? e.default : e)(window);
  function i(e) {
      return "%" == e[e.length - 1];
  }
  function o(e, r, i) {
      ...
      var n = {};
      if (((n.id = t.createProgram()), t.attachShader(n.id, o(t.VERTEX_SHADER, e)), t.attachShader(n.id, o(t.FRAGMENT_SHADER, r)), t.linkProgram(n.id), !t.getProgramParameter(n.id, t.LINK_STATUS)))
          throw new Error("link error: " + t.getProgramInfoLog(n.id));
  ...
  var s = (function () {
          ...
          for (var s = null, u = 0; u < i.length; u++)
              if (
                  (t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, 32, 32, 0, t.RGBA, i[u].type, null),
  ...
  var h = function (r, i) {
      ...
      (n.width = this.$el.innerWidth()),
          ...
          (this.context = t = n.getContext("webgl") || n.getContext("experimental-webgl")),
      ...
      for (var a = s.arrayType, u = a ? new a(this.resolution * this.resolution * 4) : null, h = 0; h < 2; h++) {
          ...
          t.bindFramebuffer(t.FRAMEBUFFER, d),
              t.bindTexture(t.TEXTURE_2D, c),
              t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, s.linearSupport ? t.LINEAR : t.NEAREST),
              t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, s.linearSupport ? t.LINEAR : t.NEAREST),
              t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE),
              t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE),
              t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, this.resolution, this.resolution, 0, t.RGBA, s.type, u),
              t.framebufferTexture2D(t.FRAMEBUFFER, t.COLOR_ATTACHMENT0, t.TEXTURE_2D, c, 0),
  ...
  (h.DEFAULTS = { imageUrl: null, resolution: 256, dropRadius: 20, perturbance: 0.03, interactive: !0, crossOrigin: "" }),
      (h.prototype = {
          setupPointerEvents: function () {
              var e = this;
              function t(t, r) {
                  e.visible && e.running && e.interactive && e.dropAtPointer(t, e.dropRadius * (r ? 1.5 : 1), r ? 0.14 : 0.01);
              }
              this.$el
              ...
              if (r != this.imageSource)
                  if (((this.imageSource = r), this.imageSource)) {
                      ...
                      (i.onload = function () {
                          ...
                          t.bindTexture(t.TEXTURE_2D, e.backgroundTexture),
                              t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, o),
                              t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, o),
                              t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, t.RGBA, t.UNSIGNED_BYTE, i),
                              (e.backgroundWidth = i.width),
                              (e.backgroundHeight = i.height),
                              e.hideCssBackground();
                      }),
                          (i.onerror = function () {
                              (t = e.context), e.setTransparentTexture();
                          }),
                          (i.crossOrigin = this.imageSource.match(/^data:/) ? null : this.crossOrigin),
          ...
          render: function () {
              t.bindFramebuffer(t.FRAMEBUFFER, null),
                  ...
                  t.useProgram(this.renderProgram.id),
                  n(this.backgroundTexture, 0),
                  n(this.textures[0], 1),
                  t.uniform1f(this.renderProgram.locations.perturbance, this.perturbance),
                  t.uniform2fv(this.renderProgram.locations.topLeft, this.renderProgram.uniforms.topLeft),
                  t.uniform2fv(this.renderProgram.locations.bottomRight, this.renderProgram.uniforms.bottomRight),
                  t.uniform2fv(this.renderProgram.locations.containerRatio, this.renderProgram.uniforms.containerRatio),
                  t.uniform1i(this.renderProgram.locations.samplerBackground, 0),
                  t.uniform1i(this.renderProgram.locations.samplerRipples, 1),
                  this.drawQuad(),
                  t.disable(t.BLEND);
          },
          update: function () {
              t.viewport(0, 0, this.resolution, this.resolution),
                  t.bindFramebuffer(t.FRAMEBUFFER, this.framebuffers[this.bufferWriteIndex]),
                  n(this.textures[this.bufferReadIndex]),
                  t.useProgram(this.updateProgram.id),
                  this.drawQuad(),
          ...
          computeTextureBoundaries: function () {
              ...
              if (
                  ("fixed" == o ? (((e = { left: window.pageXOffset, top: window.pageYOffset }).width = r.width()), (e.height = r.height())) : (((e = this.$el.offset()).width = this.$el.innerWidth()), (e.height = this.$el.innerHeight())),
                  "cover" == t)
              )
                  ...
                  i(s) ? (s = (e.width * parseFloat(s)) / 100) : "auto" != s && (s = parseFloat(s)),
                      i(u) ? (u = (e.height * parseFloat(u)) / 100) : "auto" != u && (u = parseFloat(u)),
                      "auto" == s && "auto" == u
              ...
              (this.renderProgram.uniforms.topLeft = new Float32Array([(d.left - h) / s, (d.top - c) / u])),
          ...
          initShaders: function () {
              ...
              (this.dropProgram = o(
                  ...
                  t.uniform2fv(this.updateProgram.locations.delta, this.textureDelta),
                  (this.renderProgram = o(
                      [
                          "precision highp float;",
          ...
          initTexture: function () {
              (this.backgroundTexture = t.createTexture()),
                  t.bindTexture(t.TEXTURE_2D, this.backgroundTexture),
          ...
          drop: function (e, r, i, o) {
              ...
              t.viewport(0, 0, this.resolution, this.resolution),
                  t.bindFramebuffer(t.FRAMEBUFFER, this.framebuffers[this.bufferWriteIndex]),
                  n(this.textures[this.bufferReadIndex]),
                  t.useProgram(this.dropProgram.id),
                  t.uniform2fv(this.dropProgram.locations.center, h),
                  t.uniform1f(this.dropProgram.locations.radius, i),
                  t.uniform1f(this.dropProgram.locations.strength, o),
                  this.drawQuad(),
                  this.swapBufferIndices();
          },
          updateSize: function () {
...
!(function (t) {
  ...
  function a(n) {
      ...
      return e.length
          ? (t.each(e, function (t, n) {
                ...
                /^data-in-*/.test(e)
                    ? ((a["in"] = a["in"] || {}), (a["in"][e.replace(/data-in-/, "")] = i(n.nodeValue)))
                    : /^data-out-*/.test(e)
                    ? ((a.out = a.out || {}), (a.out[e.replace(/data-out-/, "")] = i(n.nodeValue)))
  ...
  var r = function (i, o) {
      ...
      (s.init = function () {
          (s.$texts = r.find(o.selector)),
              s.$texts.length || ((s.$texts = t('<ul class="texts"><li>' + r.html() + "</li></ul>")), r.html(s.$texts)),
              s.$texts.hide(),
          ...
          (s["in"] = function (i, o) {
              ...
              c.addClass("current"),
                  ...
                  "char" == s.options.type &&
                      s.$current
                          .find('[class^="word"]')
                          .css({ display: "inline-block", "-webkit-transform": "translate3d(0,0,0)", "-moz-transform": "translate3d(0,0,0)", "-o-transform": "translate3d(0,0,0)", transform: "translate3d(0,0,0)" })
                          .each(function () {
                              t(this).lettering();
                          }),
                  ...
                  s.triggerEvent("start"),
                      (function n(t) {
                          s["in"](t, function () {
                              ...
                              (t += 1),
                                  !s.options.loop && t >= e
                                      ? (s.options.callback && s.options.callback(), s.triggerEvent("end"))
                                      : ((t %= e),
  ...
  (t.fn.textillate = function (n, e) {
      ...
      (t.fn.textillate.defaults = {
          ...
          minDisplayTime: 2e3,
          initialDelay: 0,
          in: { effect: "fadeInLeftBig", delayScale: 1.5, delay: 50, sync: !1, reverse: !1, shuffle: !1, callback: function () {} },
          out: { effect: "hinge", delayScale: 1.5, delay: 50, sync: !1, reverse: !1, shuffle: !1, callback: function () {} },
          autoStart: !0,
          inEffects: [],
          outEffects: ["hinge"],
          callback: function () {},
