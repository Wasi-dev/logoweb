...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: https://logovisioneer.com/lp1/thankyou.php");
    flush();
    ob_flush();

    // Prepare Email Data
    $to ="contact@logovisioneer.com, info@logovisioneer.com, gabriel.brown@logovisioneer.com, Aimankhan.official000@gmail.com, waseempixedustmedia@gmail.com";
