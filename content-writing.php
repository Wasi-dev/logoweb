    ...
    <div class="container">
        ...
        <div class="row video-anim-process-responsive-slider">
            <div class="col-lg-4 col-md-12">
                ...
                <p>Let us know about your requirements, including content, the quantity of pages, and place your order. Give us details about what kind of content you have in mind and what's your time limit. </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-12">
                <div class="v-anim-process-box anim-2">
                <h3>Expert Writing</h3>
                <p>Our experienced and skilled writing team will develop original and high-quality content for you. We will write compelling copy that is conversion-focused and optimize it for SEO. </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-12">
                <div class="v-anim-process-box anim-3">
                <h3>Approval</h3>
                <p>The last step is reviewing all the steps and making content flawless. Moreover, we offer unlimited revisions at no additional cost to ensure that is ideal for you. </p>
                </div>
            </div>
        </div>
    </div>
